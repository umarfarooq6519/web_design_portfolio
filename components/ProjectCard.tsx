...
const ProjectCard = ({ project }: { project: ProjectType }) => {
  return (
    ...
    >
      <div className="content flex flex-col xl:w-full xl:max-w-md xl:justify-between xl:py-1">
        <span>
      ...
      <div className="relative h-[280px] w-full sm:h-[380px] md:h-[480px] lg:h-[580px] xl:min-w-5xl">
        <Image
